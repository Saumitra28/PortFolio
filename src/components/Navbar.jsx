...
const Navbar = () => {
  ...
  return (
    <div
      className={
        !showShadowNav
          ? "fixed w-full h-[80px] flex justify-between items-center px-4 bg-gradient-to-br from-[#100E09] to-[#1C1C1C] text-gray-300 z-20"
          : "fixed w-full h-[80px] flex justify-between items-center px-4 bg-gradient-to-br from-[#100E09] to-[#1C1C1C] text-gray-300 z-20 shadow-2xl"
      }
    >
      <div>
      ...
      <div className="hidden lg:flex fixed flex-col top-[35%] left-0">
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://www.linkedin.com/in/saumitra-upadhyay-39a742210/"
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="https://github.com/Saumitra28"
              className="flex justify-between items-center w-full text-[#3A1078]"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-slate-200 rounded-e-2xl font-semibold">
            <a
              href="mailto:saumitraupadhyay28@gmail.com"
              className="flex justify-between items-center w-full text-[#3A1078]"
            >
